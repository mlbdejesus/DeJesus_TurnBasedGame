package com.example.dejesus_turnbasedgame;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtHeroName = findViewById(R.id.txtHName);
        txtMonsName = findViewById(R.id.txtMName);
        txtHeroHP = findViewById(R.id.txtHHP);
        txtMonsHP = findViewById(R.id.txtMHP);
        txtHeroMP = findViewById(R.id.txtHMP);
        txtMonsMP = findViewById(R.id.txtMMP);
        txtHeroDps = findViewById(R.id.txtHDPS);
        txtMonsDps = findViewById(R.id.txtMDPS);
        btnNextTurn = findViewById(R.id.btnNext);
        txtHeroName.setText(heroName);
        txtHeroHP.setText(String.valueOf(heroHP));
        txtHeroMP.setText(String.valueOf(heroMP));
        txtMonsName.setText(monsName);
        txtMonsHP.setText(String.valueOf(txtMonsHP));
        txtMonsMP.setText(String.valueOf(txtMonsMP));
